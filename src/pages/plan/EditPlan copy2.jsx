...
//       plannerId: parseInt(id, 10), // 플래너 ID를 Long 타입으로 변환
//       plannerTitle, // 플래너 제목
//       plannerStartDate: startDate, // 출발일
//       plannerEndDate: endDate, // 도착일
//       regionId: parseInt(regionId, 10), // 지역 ID를 Long 타입으로 변환
//       regionName: cityName, // 연결된 지역 이름
//       dailyPlans: Object.entries(dailyPlans).map(([date, places]) => ({
//         planDate: date, // 날짜
//         toDos: places.map((place) => ({
//           toDoId: place.toDoId || null, // ToDo ID (없으면 null)
//           locationId: place.locationId, // 장소 ID
//           locationName: place.locationName, // 장소 이름
//           formattedAddress: place.formattedAddress, // 주소
//           latitude: place.latitude, // 위도
//           longitude: place.longitude, // 경도
//           placeImgUrl: place.placeImgUrl || "", // 이미지 URL (없으면 빈 문자열)
//         })),
//       })),
//     };

//     console.log("Updated Planner:", updatedPlanner); // 요청 데이터 확인
...
//     } catch (error) {
//       console.error("플래너 수정 실패:", error);
//       alert("플래너 수정 중 오류가 발생했습니다. 다시 시도해주세요.");
//     }
//   };
