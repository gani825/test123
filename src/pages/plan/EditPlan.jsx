...
// function EditPlan() {
//   const { id } = useParams(); // 플래너 ID 가져오기
...
//   const [regionId, setRegionId] = useState(null); // 추가: regionId 상태
...
//         setRegionId(plannerData.regionId); // regionId 설정
...
//           setCenter({
//             lat: allPlaces[0].latitude || 35.6895,
//             lng: allPlaces[0].longitude || 139.6917,
//           });
//         }
//       } catch (error) {
//         console.error('플래너 데이터를 불러오는 데 실패했습니다:', error);
//         alert('플래너 데이터를 불러오는 데 실패했습니다.');
//       }
//     };
