            ...
            <div className="slide">
                ...
                >
                    <SwiperSlide className="slide-item">
                        <div className="slide-content" style={{backgroundImage: `url(${MainBanner})`}}><a
                            href="#"><span> 떠나고 싶은 그 순간, 일본의 하늘 아래에서 새로운 이야기를 시작하세요.</span></a></div>
                    </SwiperSlide>
                    <SwiperSlide className="slide-item">
                        <div className="slide-content" style={{backgroundImage: `url(${SecondBanner})`}}><a
                            href="#"><span>환상적인 밤 벚꽃길, 마음을 밝히는 등불 아래에서 추억을 만드세요.</span></a></div>
                    </SwiperSlide>
                    <SwiperSlide className="slide-item">
                        <div className="slide-content" style={{backgroundImage: `url(${ThirdBanner})`}}><a
                            href="#"><span>분홍빛 벚꽃과 도쿄의 불빛, 잊지 못할 봄의 풍경이 펼쳐집니다.</span></a></div>
                    </SwiperSlide>
                </Swiper>
            </div>
                            ...
                            <div className="plan-dayAll">
                                <div className="plan-day">
                                    ...
                                    <ul>
                                        ...
                                        <li><span
                                            className="landmark-tag">랜드마크</span> 센소지<br/><span>15:30 - 17:00</span></li>
                                        <li><span className="landmark-tag">랜드마크</span> 오사카
                                            성<br/><span>18:00 - 20:00</span></li>
                                    </ul>
                                </div>
                                <div className="plan-day">
                                    <h5>2일차</h5>
                                    <ul>
                                        ...
                                        <li><span className="landmark-tag">랜드마크</span> 도쿄
                                            타워<br/><span>15:30 - 17:00</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
